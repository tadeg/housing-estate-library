...
class NewBook extends Component {
    ...
    render() {
        return ( <
            ...
            error = {
                this.state.errors.errOfauthorFirstname
            }
            /> <
            /Col>
            ...
            error = {
                this.state.errors.errOfauthorLastname
            }
            /> <
            /Col>
            ...
            error = {
                this.state.errors.errOfpublisher
            }
            /> <
            /Col>
            ...
            error = {
                this.state.errors.errOfpublicationYear
            }
            /> <
            /Col>
            ...
            <
            NewBookDataSelect name = "language"
            label = "Language"
            className = "form-control"
            value = {
                this.state.language
            ...
            error = {
                this.state.errors.errOflanguage
            }
            /> <
            /Col>
            ...
            <
            NewBookDataInput type = "checkbox"
            name = "newedition"
            ...
            error = {
                this.state.errors.errOfnewedition
            }
            /> <
            /Col>
